...
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;
using Abc.Shared.Code.GroupProjectCode;
...
// PARANDATUD ALTERNATIIVSE SÜNTAKSIGA (EI KASUTA KOLMNURKSULGE, ET KOPEERIMINE EI SAKSIKS)
builder.Services.AddScoped(typeof(IdentityRedirectManager));
builder.Services.AddScoped(typeof(Microsoft.AspNetCore.Components.Authorization.AuthenticationStateProvider), typeof(IdentityRevalidatingAuthenticationStateProvider));
...
// KUTSUME ÜHIST TEENUSTE REGISTREERIMIST SERVERI ÜHENDUSEGA
